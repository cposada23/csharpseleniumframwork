...
public static class VeryBadCodeHtmlTableExtension
{
    //Read of Table
    ...
    private static ColumnSpecialValue? GetControl(ISearchContext columnValue)
    {
        ...
        string columnValue)
    {
        ...
        //dynamic row
        return (
            from table in tableCollection 
            where table.ColumnName == columnName && table.ColumnValue == columnValue
            select table.RowNumber).Cast<object>();
    }
}
